...
# -----------------------------------------------------------------------------
# Static file serving (kept as-is)
# -----------------------------------------------------------------------------
...
def serve(path):
    ...
    absolute = os.path.join(static_folder_path, path)
    if path != "" and os.path.exists(absolute):
...
if __name__ == "__main__":
    # 0.0.0.0 makes it reachable from other devices on your LAN if needed
